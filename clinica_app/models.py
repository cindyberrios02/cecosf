...
class User(AbstractUser):
    username = None
    email = models.EmailField('email', unique=True, default='1',max_length=50)
    first_name = models.CharField(max_length=50, default='1')
...
class Patient(models.Model):
    ...
    dni = models.CharField(max_length=8, verbose_name='DNI', null=True, blank=True, default='1')
    phone = models.IntegerField(default=0, null=True, blank=True)
    address = models.CharField(max_length=50, verbose_name='Dirección', null=True, blank=True, default='1')
    city = models.CharField(max_length=40, verbose_name='Ciudad', null=True, blank=True, default='1')
    social_work = models.CharField(max_length=20, verbose_name='Obra Social', null=True, blank=True, default='1')
    sw_number = models.CharField(max_length=20, verbose_name='Número de Obra Social', null=True, blank=True, default='1')
...
class Specialist(models.Model):
    name = models.CharField(max_length=100, unique=True, null=True, default='Medicina General')
...
class Doctor(models.Model):
    ...
    address = models.CharField(max_length=50, verbose_name='Dirección', null=True, blank=True, default='1')
    city = models.CharField(max_length=40, verbose_name='Ciudad', null=True, blank=True, default='1')
    mr_number = models.CharField(max_length=20, verbose_name='Número de Matrícula', null=True, blank=True, default='1')
